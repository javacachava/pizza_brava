...
export const POSPage = () => {
  ...
  const { filteredProducts, filteredCombos } = useMemo(() => {
    ...
    // Filtramos Combos (categoryId "combos")
    const fCombos = (combos || []).filter(c => {
      const matchCat = isAll || c.categoryId === selectedCategoryId || selectedCategoryId === 'combos';
